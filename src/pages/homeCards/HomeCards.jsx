        ...
        <div>
                <div className="bg-gray-100 py-8 container rounded-lg">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <p className="mt-2 text-lg text-gray-600">30-Minute Healthy and Delicious Indian Recipes: Quick and Easy Meals for Your Busy Lifestyle</p>
                    </div>
                </div>
            ...
            {cards.map((card, index) => (
                ...
                >
                    <div className="flex items-center mb-6">
                        <div className="rounded-full bg-white p-2">{card.icon}</div>
